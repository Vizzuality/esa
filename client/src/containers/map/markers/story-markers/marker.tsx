  ...
  return (
    <>
      <Marker key={id} longitude={lng} latitude={lat}>
        <div
          className={cn({
            'h-[32px] w-[70px] overflow-hidden rounded-full border-[3px] border-gray-200 shadow-md shadow-gray-950/25 transition-all duration-500 hover:h-[200px] hover:w-[200px]':
              true,
